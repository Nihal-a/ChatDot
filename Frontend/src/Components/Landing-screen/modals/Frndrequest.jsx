...
const Frndrequest = ({ isOpen, onClose }) => {
  ...
  return (
    <div className=" fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg w-[50%] h-[70%]  shadow-lg">
        ...
        <div className="w-[98%] h-[80%] grid grid-cols-2">
          <div className=" mb-4 w-full h-full ">
            <p className="w-[90%]   text-white dark:text-white text-2xl   pb-3.5  ">
              Friend Requests
            </p>{" "}
            <div
              className="w-full h-[52%] overflow-y-auto pt-3 px-3 rounded-md "
            ...
            >
              {dummyUsers.map((user, index) => (
                ...
                >
                  {/* Avatar */}
                  <div className="ring-1 w-[50px] h-[50px] rounded-full overflow-hidden ml-3">
                    <img
                      src=""
                      alt="profile"
              ...
              >
                {dummyUsers.map((user, index) => (
                  ...
                  >
                    ...
                    <button className="rounded-md py-0.5 px-2 ring-1 ring-[#68479D] bg-[#68479D] text-white text-sm font-medium hover:bg-[#7c62a5]">
                      CANCEL
                    </button>
                  </div>
                ))}
