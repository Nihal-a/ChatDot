...
const Signup = () => {
  ...
  const EmailVerfication = async (e) => {
    ...
    try {
      setloading(true);
      const res = await fetch("http://127.0.0.1:8000/api/email_verification", {
        method: "POST",
        headers: {
  ...
  const otpVerification = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("http://127.0.0.1:8000/api/otp_verification", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const UserNameValidation = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("http://127.0.0.1:8000/api/username_validation", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
